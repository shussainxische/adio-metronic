...
import { IconComponent, StatusBadgeComponent, StatusBadgeVariant } from '@components/ui/_index';

import { ApplicationStatusDto, EntityReview } from '@models/esp/_index';
...
@Component({
  ...
  standalone: true,
  imports: [
    CommonModule, FormsModule, IconComponent, StatusBadgeComponent, GeneralSubStageComponent,
    EconomicImpactSubStageComponent, ProductivitySubStageComponent, EmsDmsSubStageComponent,
    SummarySubStageComponent, ReviewSubmitSubStageComponent
  ],
