...
import {
  ApplicationStatusDto, ApplicationEvaluationDto, ApplicationSummaryDto, RfqApplicationDto
} from '@models/esp/_index';

import {
  TabNavigationComponent, IconComponent, ButtonComponent, InfoTableData
} from '@components/ui/_index';

import {
  ApplicationStatusService, BaseRfqApplicationService, BaseApplicationsSummaryService, ApplicationEvaluationService
} from '@services/_index';

// Stage Components
import {
  TammApplicationStageComponent, RfqStageComponent,/* EvaluationStageComponent,*/ ReviewStageComponent,
  CompletedStageComponent
} from '../../components/application-detail/stages/_index';
...
export class ApplicationDetailComponent implements OnInit {
  ...
  application: ApplicationStatusDto | null = null;
  ...
  private quotationData: RfqApplicationDto | null = null;

  // Evaluation data
  evaluationData: ApplicationEvaluationDto | null = null;
  ...
  constructor(
    ...
    private evaluationApiService: ApplicationEvaluationService
  ) { }
  ...
  private createApplicationFromQuotationData(data: RfqApplicationDto, summaryItem?: ApplicationSummaryDto): ApplicationStatusDto {
  ...
  goBack() {
    this.router.navigate(['/esp/cb/dashboard']);
  }
