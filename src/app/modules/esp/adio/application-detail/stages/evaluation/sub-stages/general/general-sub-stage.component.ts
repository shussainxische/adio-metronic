...
import { InputComponent, DateInputComponent, IconComponent } from '@components/ui/_index';

import { EvaluationDataService } from '@services/esp/evaluation-data.service';

import { ApplicationStatusDto } from '@models/esp/_index';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, InputComponent, DateInputComponent, IconComponent],
