...
import {
  TopCardComponent, PreviewCardComponent, PageHeaderComponent, IconComponent, StatusBadgeComponent,
  ProgressBarComponent, FilterButtonComponent, ViewToggleComponent, StatsCardComponent, StatusFilterButtonComponent,
  TablePaginationComponent, ActionButtonsComponent, DataTableComponent
} from '@components/ui/_index';

import {
  ApplicationStatusService, ApplicationAssignmentService, ApplicationFiltersService, BaseApplicationFilterService,
  BaseApplicationsService, BaseApplicationsSummaryService
} from '@services/_index';


import { CompactSearchComponent } from './compact-search/compact-search.component';
import { ApplicationStatusDto, ApplicationSummaryDto, ApplicationDetail } from '@models/esp/_index';

import { DataTableColumn } from '@models/ui/_index';
import { AppType, Stage } from '@models/esp/_index';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, TranslateModule, TopCardComponent, PreviewCardComponent, PageHeaderComponent, IconComponent, StatusBadgeComponent, ProgressBarComponent, FilterButtonComponent, ViewToggleComponent, StatsCardComponent, StatusFilterButtonComponent, TablePaginationComponent, ActionButtonsComponent, DataTableComponent, CompactSearchComponent],
...
export class ApplicationsComponent implements OnInit {
  ...
  navigateToDetailWithStage(app: ApplicationStatusDto) {
    ...
    this.router.navigate(['/esp/adio/applications', applicationId], { queryParams });
  }
