...
import { NotificationService } from '../../../../../services/esp/notification.service';


@Component({
  selector: 'app-notifications',
  standalone: true,
  imports: [CommonModule, TranslateModule, PageHeaderComponent, TablePaginationComponent, NotificationCardComponent, TabNavigationComponent, TableNoDataComponent],
