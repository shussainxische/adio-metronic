...
import {
  ApplicationStage, ApplicationStatusDto, ApplicationSummaryDto, RfqApplicationDto, ApplicationEvaluationDto
} from '@models/esp/_index';

import {
  ApplicationStatusService, BaseApplicationsSummaryService, BaseRfqApplicationService, ApplicationEvaluationService
...
// Stage Components
import {
  TammApplicationStageComponent, RfqStageComponent, /*EvaluationStageComponent*/
  ReviewStageComponent, CompletedStageComponent
} from './stages/_index';
...
export class ApplicationDetailComponent implements OnInit {
  ...
  constructor(
    ...
    public evaluationApiService: ApplicationEvaluationService
  ) { }
